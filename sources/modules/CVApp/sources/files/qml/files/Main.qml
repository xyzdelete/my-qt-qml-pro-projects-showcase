              ...
              ColumnLayout {
                ...
                TextEdit {
                  ...
                  MouseArea {
                    ...
                    onClicked: Qt.openUrlExternally("mailto:xyzdelete@protonmail.com")
                  }
                }
                Text {
          ...
          Item {
            ...
            Rectangle {
              ...
              ColumnLayout {
                ...
                Text {
                  text: qsTr("I am a software developer and I have years of experience in programming. My main tool is C++ (latest standard) but I also have knowledge about latest Qt, QML, CMake, Git, Python, Docker, cross-compilation, WebAssembly and many other tools including AI tools. I'm agile and always ready to learn. By nature, I am a perfectionist and I have QA-like attention to detail. In addition, I have some knowledge about JavaScript and web development. I have experience developing software for and working across Windows, macOS, Linux, Android, iOS, and WebAssembly environments. Furthermore, I like computer games and experimenting with Unreal Engine 5.")
                  color: root.darkTheme ? "#F4FBFF" : "#153047"
                  Layout.alignment: Qt.AlignHCenter
                  Layout.maximumWidth: summaryLayout.width
          ...
          Item {
            ...
            Rectangle {
              ...
              ColumnLayout {
                ...
                Text {
                  text: qsTr("• Windows • Linux • macOS • iOS • Android • WebAssembly")
                  color: root.darkTheme ? "#F4FBFF" : "#123044"
                  Layout.alignment: Qt.AlignLeft
                  Layout.maximumWidth: skillsAndToolsLayout.width
                  wrapMode: Text.WordWrap
            ...
            Rectangle {
              ...
              GridLayout {
                ...
                ColumnLayout {
                  ...
                  Text {
                    text: qsTr("• Designed and developed new software features for payment engine deployed on embedded devices.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Improved and maintained CI/CD pipelines to enhance build, testing, and deployment processes.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Maintained, refactored, and enhanced legacy codebases while ensuring reliability and maintainability.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Developed and troubleshot software within Linux-based environments.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Collaborated with development and engineering teams to deliver robust and high-quality software solutions.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Programming Languages:</b> C++, Python, Bash")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Operating Systems:</b> Windows, Linux")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Version Control:</b> Git")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Containerization:</b> Docker")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>CI/CD:</b> Continuous Integration and Continuous Deployment")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Domain:</b> Embedded systems and payment processing")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                ...
                ColumnLayout {
                  ...
                  Text {
                    text: qsTr("• Provided strategic and technical advisory support to the founding and development teams.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Participated in quality assurance activities to identify functional, usability, and reliability issues.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Evaluated UI/UX aspects to enhance usability and overall user experience.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Identified potential vulnerabilities and security-related issues.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>PWA:</b> Progressive Web App")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Operating Systems:</b> Windows, macOS, Android, iOS, Web (PWA)")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Domain:</b> WEB3 and payment processing")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                ...
                ColumnLayout {
                  ...
                  Text {
                    text: qsTr("• SoundID Reference headphone / speaker calibration software (SoundID Reference standalone app and DAW plugins)")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Designed, developed, and maintained cross-platform desktop software with graphical user interfaces (GUIs).")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Designed and developed advanced cross-platform internal tools with graphical user interfaces.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Participated in development of cross-platform integrations for various external partners.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Developed and maintained software across Windows and macOS environments.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• Maintained, refactored, and enhanced legacy codebases to ensure stability and maintainability.")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Programming Languages:</b> C++, Python")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Operating Systems:</b> Windows, macOS")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                  ...
                  Text {
                    text: qsTr("• <b>Domain:</b> Audio calibration software / DSP (digital signal processing) software")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
                ...
                ColumnLayout {
                  ...
                  Text {
                    text: qsTr("• <b>Programming Languages:</b> C++")
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    color: root.darkTheme ? "#F4FBFF" : "#123044"
            ...
            Rectangle {
              ...
              GridLayout {
                ...
                ColumnLayout {
                  ...
                  Text {
                    text: qsTr("Web deployment (<b>WebAssembly</b>):")
                    textFormat: Text.RichText
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                  ...
                  Text {
                    text: qsTr("<b>CVApp</b><br><b>URL</b>: <u>\u200Bcv\u200B-arturs\u200B-anikins\u200B.netlify\u200B.app</u>")
                    textFormat: Text.RichText
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    ...
                    MouseArea {
                      ...
                      cursorShape: Qt.PointingHandCursor
                      onClicked: {
                        Qt.openUrlExternally("https://cv-arturs-anikins.netlify.app/");
                      }
                    }
                  }
                  Text {
                    text: qsTr("<b>RESTClientApp</b><br><b>URL</b>: <u>\u200Brestclientapp\u200B-arturs\u200B-anikins\u200B.netlify\u200B.app</u>")
                    textFormat: Text.RichText
                    Layout.fillWidth: true
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignLeft
                    ...
                    MouseArea {
                      ...
                      cursorShape: Qt.PointingHandCursor
                      onClicked: {
                        Qt.openUrlExternally("https://restclientapp-arturs-anikins.netlify.app/");
                      }
                    }
                  }
                  Text {
