...
int
SingletonClass::someProperty() const
{
  return m_someProperty;
}

void
SingletonClass::setSomeProperty(int someProperty)
{
...
QObject*
SingletonClass::singletonProvider(QQmlEngine* engine, QJSEngine* scriptEngine)
{
  Q_UNUSED(engine)
  Q_UNUSED(scriptEngine)

  static SingletonClass* example = new SingletonClass();
  return example;
}
