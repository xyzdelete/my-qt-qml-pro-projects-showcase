...
PersonModel::PersonModel(QObject* parent)
  : QAbstractListModel(parent), m_dataSource(nullptr), m_signalConnected(false)
{
...
void PersonModel::addPerson(
  const QString& names, const QString& favoriteColor, const int& age)
{
