...
QString
FootBallTeam::title() const
{
  return m_title;
}

QString
FootBallTeam::coatch() const
{
  return m_coatch;
}

Player*
FootBallTeam::captain() const
{
  return m_captain;
}

void
FootBallTeam::setTitle(QString title)
{
  if (m_title == title)
    return;
...
void
FootBallTeam::setCoatch(QString coatch)
{
  if (m_coatch == coatch)
    return;
...
void
FootBallTeam::setCaptain(Player* captain)
{
...
void
FootBallTeam::appendPlayerCustom(Player* player)
{
...
int
FootBallTeam::playerCountCustom() const
{
  return m_players.count();
}

Player*
FootBallTeam::playerCustom(int index) const
{
  return m_players.at(index);
}

void
FootBallTeam::clearPlayersCustom()
{
  m_players.clear();
}

void
FootBallTeam::appendPlayer(QQmlListProperty<Player>* list, Player* player)
{
  reinterpret_cast<FootBallTeam*>(list->data)->appendPlayerCustom(player);
}

qsizetype
FootBallTeam::playerCount(QQmlListProperty<Player>* list)
{
  return reinterpret_cast<FootBallTeam*>(list->data)->playerCountCustom();
}

Player*
FootBallTeam::player(QQmlListProperty<Player>* list, qsizetype index)
{
  return reinterpret_cast<FootBallTeam*>(list->data)->playerCustom(index);
}

void
FootBallTeam::clearPlayers(QQmlListProperty<Player>* list)
{
