...
class ObjectListWrapper : public QObject
{
  Q_OBJECT
  QML_SINGLETON
  QML_NAMED_ELEMENT(Wrapper)
  Q_PROPERTY(QList<QObject*> persons READ persons NOTIFY personsChanged)
public:
...
private:
  ...
  QList<QObject*>
    mPersons;  // This should be QObject*, Person* is not going to work in QML
