...
```
python align-and-sign.py --build-dir "C:/build/host-x64-windows-target-arm64-android"
```
...
keytool -genkeypair -v -keystore .android-keystore\aa-android-release-sign-keystore.jks -alias release -keyalg RSA -keysize 8192 -validity 36500 -storetype PKCS12
```
...
python align-and-sign.py --silent `
    --build-dir "C:/build/host-x64-windows-target-arm64-android" `
    --keystore-file ".android-keystore/aa-android-release-sign-keystore.jks" `
    --key-alias release
```
